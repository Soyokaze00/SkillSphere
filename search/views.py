...
# def _get_project_suggestions(query=None, limit=5, exclude_ids=None):
...
#     return list(qs.values("id", "title")[:limit])
...
#         'suggested_searches': _get_project_suggestions(
...
#     projects = _get_project_suggestions(query)
#     users = list(
...
#     return JsonResponse({"projects": projects, "users": users})
...
# def get_user_suggestions(query, limit=5):
#     return list(
#         CustomUser.objects.annotate(
#             similarity=Greatest(
#                 TrigramSimilarity("username", query),
